# CLAUDE.md
## このリポジトリについて
田中風花のポートフォリオサイト。現在のHTML/SCSS/JS構成からNext.js + microCMSへ移行中。

## 移行方針
### 私の方針
- **自分で手を動かしながら学ぶ**ことを最優先にしています
- コードを直接出力しないでください
- 代わりに「何をすべきか」「なぜそうするのか」をヒントとして教えてください
- 詰まったときは段階的にヒントを出してください（いきなり答えは不要）

### お願いしたいこと
- 実装の方向性や考え方を示してください
- エラーが出たときは原因の見当たり方を教えてください
- 「この書き方で合っていますか？」という確認には答えてください
...
### コンテンツ構成
- トップページ：index.html → app/page.tsx
- 実績詳細：works.html / works2.html → app/works/[slug]/page.tsx（microCMSから取得）
